...
interface SummaryProps {
    ...
    setSummaryCache: React.Dispatch<
...
const SummaryFromFile = ({
    ...
    if (!file) return null;
    if (summaryLoading)
        return <p className="mt-2 text-center">Processing PDF...</p>;
    if (summaryError)
        return <p className="text-red-500 mt-2">{summaryError}</p>;
        ...
        <div className="mt-4">
            ...
            <ul className="space-y-2">
                {topics.map((t, index) => (
                    <li key={index}>
                        <div
                            className={`p-2 rounded cursor-pointer hover:bg-neutral-200 dark:hover:bg-neutral-800 flex items-center justify-between ${
                                expandedIndex === index
                                    ...
                                    >
                                        ...
                                        >
                                            <path
                                                ...
                                                d="M16.862 4.487a2.1 2.1 0 1 1 2.97 2.97L7.5 19.788l-4 1 1-4 13.362-13.3z"
                                            />
                                        </svg>
                                    </button>
                                )}
